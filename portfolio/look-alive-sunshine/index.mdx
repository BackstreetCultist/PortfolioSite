...
<h3>
TLDR: A VS Code extension which polices the amount of typing done by the user.
Based on a lack of user input, the system takes steps up to and including
ringing the user's phone using Twilio, posting their internet history on Twitter
using bots and a Chrome extension, and operating a crudely-made coffee machine.
<br />Created at ManMetHacks2.0, Look Alive, Sunshine was awarded Best Hardware Hack.
</h3>
...
get back to bed than to get building. We needed something to keep ourselves
...
<img
src="https://s3.eu-west-2.amazonaws.com/charliewilkins.tech/images/portfolio/look-alive-sunshine/twilio.png"
alt="The Twilio logo" 
...
effect. However, it was Threat Levels 4 and 5 which really made the
...
<img
src="https://s3.eu-west-2.amazonaws.com/charliewilkins.tech/images/portfolio/look-alive-sunshine/architecture.png"
...
to access directly. Much like the vampire it resembles, it must first be invited. The simplest
...
<img
src="https://s3.eu-west-2.amazonaws.com/charliewilkins.tech/images/portfolio/look-alive-sunshine/sunshine.png"
...
for us as, after some debate about how exactly to categorise it, Look Alive, Sunshine
was awarded the Best Hardware Hack prize by the event's judges. 

<img
src="https://s3.eu-west-2.amazonaws.com/charliewilkins.tech/images/portfolio/look-alive-sunshine/prize.png"
...
[story for another time](https://www.charliewilkins.tech/blog/nova-team).
