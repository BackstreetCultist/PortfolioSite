...
hero_image: "https://s3.eu-west-2.amazonaws.com/charliewilkins.tech/images/portfolio/famous-last-words/banner.png"
hero_image_alt: "The Famous Last Words mask is projected in a lecture theatre during the demo"
hero_image_credit_text: "Image courtesy of CovHack 2020 team"
...
<h3>
TLDR: A Discord bot uses Google Cloud's Sentiment Analysis to measure the
opinions of users. If a user expresses a "banned" opinion, the system responds
with procedurally-generated propaganda images and by awakening a physical
"watcher" with glowing red eyes.<br />Created at CovHack 2020, Famous Last Words was
awarded Best Use of Google Cloud.
</h3>
...
our laurels, and we decided (based on me and one other team member being [AI specialists](https://www.charliewilkins.tech/blog/my-ai-degree))
...
<img
src="https://s3.eu-west-2.amazonaws.com/charliewilkins.tech/images/portfolio/famous-last-words/architecture.png"
...
We decided that, for the purposes of demonstrating the project,
...
about meat or meat-eating. For example, the sentence "I love steak" would have
succeeded in triggering the bot. It was felt that veganism would be a useful
ideology to prove the effectiveness of the system without requiring any
particularly contentious or sensitive content.
...
<img
src="https://s3.eu-west-2.amazonaws.com/charliewilkins.tech/images/portfolio/famous-last-words/mask.png"
alt="A cardboard mask with red glowing eyes" 
style="width:100%, max-width:480px"
/>

Codenamed the "Eye of Sauron" (which is [somewhat eerily prescient](https://www.inputmag.com/culture/mark-zuckerberg-employees-call-him-eye-sauron)),
...
<img
src="https://s3.eu-west-2.amazonaws.com/charliewilkins.tech/images/portfolio/famous-last-words/mask.gif"
...
and deployment of Sentiment Analysis (which I've never seen deployed by another
hackathon project) netted us a Best Use of Google Cloud prize.
